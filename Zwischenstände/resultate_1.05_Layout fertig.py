...
st.markdown("<h1 style='text-align: center;'>Bereit zur Abholung:</h1>", unsafe_allow_html=True)
        ...
        for index, row in nicht_abgeholt_df.iterrows():
            ...
            with cols[index % 2]:  # Verteile die Bestellnummern auf die Spalten
                st.markdown(
                    ...
                    f"<span style='font-size: 36px; color: #000080;'><strong>{row['Bestellnummer']}</strong></span></div>", 
